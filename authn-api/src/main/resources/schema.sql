...
CREATE TABLE hibernate_seq ( next_val BIGINT );

CREATE TABLE USERS ( id INTEGER IDENTITY PRIMARY KEY, username VARCHAR(255) NOT NULL, encrypted_password VARCHAR(255) NOT NULL );